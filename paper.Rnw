...
<<F1A,eval=TRUE,dev="png",fig.ext="png",cache=TRUE,dpi=300,out.width="0.8\\linewidth",echo=FALSE, fig.cap="Image plots of the mismatch and perfect match probe intensities for the first replication of the mutant yeast strain. The corresponding times are indicated in the plot.", fig.pos="h">>=
par(mar=c(3,3,2,1), 
...
<<F2A,eval=TRUE,dev="pdf",fig.ext="pdf",cache=TRUE,out.width="0.6\\linewidth",echo=FALSE, fig.cap="Density plots for the first replication of the mutant yeast strain.",nice.par=TRUE,message=FALSE>>=
par(mar=c(3,3,2,1), 
           mgp=c(2,0.4,0), tck=-.01,
               cex.axis=0.9, las=1)
run_chunk("s_fig2")
...
<<F3A,eval=TRUE,dev="pdf",fig.ext="pdf",cache=TRUE,out.width="0.8\\linewidth",echo=FALSE, message=FALSE,fig.cap="Boxplots of the raw and normalised intensities. The default boxplot is to include both PM and MM intensities, whereas for the density plots in Figure~\ref{F2} the default is for only the PM intensities.">>=
par(mar=c(3,3,2,1), 
           mgp=c(2,0.4,0), tck=-.01,
...
\bigskip
<<F4A,eval=TRUE,dev="pdf",fig.ext="pdf",cache=TRUE,out.width="0.6\\linewidth",echo=FALSE, fig.cap="Time course expression levels for the top differentially expressed gene, ranked by their Hotelling statistic using the \texttt{timecourse} library.">>=
par(mar=c(3,3,2,1), 
           mgp=c(2,0.4,0), tck=-.01,
               cex.axis=0.9, las=1)
run_chunk("s_fig4")
...
\midrule
affy & \Sexpr{packageDescription("affy")$Version}   & IRanges & \Sexpr{packageDescription("IRanges")$Version} \\
affyPLM & \Sexpr{packageDescription("affyPLM")$Version}  & limma & \Sexpr{packageDescription("limma")$Version} \\
AnnotationDbi & \Sexpr{packageDescription("AnnotationDbi")$Version} & Mfuzz & \Sexpr{packageDescription("Mfuzz")$Version} \\
ArrayExpress & \Sexpr{packageDescription("ArrayExpress")$Version} & timecourse & \Sexpr{packageDescription("timecourse")$Version}  \\
Biobase & \Sexpr{packageDescription("Biobase")$Version}  & yeast2probe & \Sexpr{packageDescription("yeast2probe")$Version} \\
Biostrings & \Sexpr{packageDescription("Biostrings")$Version} & yeast2cdf & \Sexpr{packageDescription("yeast2cdf")$Version} \\
gcrma & \Sexpr{packageDescription("gcrma")$Version}  & \\
\bottomrule
\end{tabular}
\caption{List of packages from Bioconductor used in this paper.}\label{AT.1}
\end{table}
...
Package & Version & Package & Version \\
\midrule
bitops & \Sexpr{packageDescription("bitops")$Version}  & GeneNet & \Sexpr{packageDescription("GeneNet")$Version} \\
caTools & \Sexpr{packageDescription("caTools")$Version} & gplots & \Sexpr{packageDescription("gplots")$Version} \\ 
corpcor & \Sexpr{packageDescription("corpcor")$Version} & grid & \Sexpr{packageDescription("grid")$Version} \\
e1071 & \Sexpr{packageDescription("e1071")$Version}  & gtools & \Sexpr{packageDescription("gtools")$Version}  \\
fdrtool & \Sexpr{packageDescription("fdrtool")$Version} & MASS & \Sexpr{packageDescription("MASS")$Version} \\
gdata & \Sexpr{packageDescription("gdata")$Version}  & longitudinal &
\Sexpr{packageDescription("longitudinal")$Version}  \\
\bottomrule

\end{tabular}
\caption{List of packages from the CRAN repository used in this paper.}\label{AT.2}
