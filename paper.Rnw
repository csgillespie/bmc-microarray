...
{\small\begin{verbatim}
    AffyBatch object
    size of arrays=496x496 features (53 kb)
    ...
    notes=c("E-MEXP-1551", "", "", "", "", "")
	    c("E-MEXP-1551", "", "", "", "", "")
	    c("temperature", "phenotype", "time", "", "", "")
	    c("time_series_design", "genetic_modification_design", 
	        "stimulus_or_stress_design", "in_vitro_design", 
	        "co-expression_design", "transcription profiling by array")
\end{verbatim}}
...
Also available from \cc{ArrayExpress} are the experimental conditions. However some preprocessing is necessary:
...
\noindent The following code (adapted from lecture material found at
